...
class App extends Component {
    constructor(props) {
        ...
        this.state = {
            headerItems: [
                {name: 'Info', active: true, desc: 'info'},
                {
                    name: 'Campers',
                    active: false,
                    content: [{
                        ...
                        stars: 3,
                        price: 140,
                        photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/White_Fiat_Ducato_Campervan_2006.jpg/1200px-White_Fiat_Ducato_Campervan_2006.jpg'
                    },
                        {
                            name: 'camper2',
                            stars: 2,
                            price: 100,
                            photo: 'https://cdn2.melodijolola.com/media/files/styles/nota_imagen/public/field/image/camper.jpg'
                        },
                        {
                            name: 'camper3',
                            stars: 1,
                            price: 70,
                            photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRG_NFQkqdgVIDcdL8-yw0j9sh2CcTcaVXBKeFIMRIBjC0U6vvT'
                        }]
                },
                {
                    name: 'Limousines',
                    ...
                    content: [{
                            ...
                            stars: 2,
                            price: 500,
                            photo: 'https://www.weselezklasa.pl/images/gallery/119/11158_12.jpg'
                        },
                        {
                            name: 'limuzyna2',
                            stars: 3,
                            price: 2000,
                            photo: 'https://thumbs.img-sprzedajemy.pl/1000x901c/3d/69/45/hummer-limuzyna-najwiekszy-w-europie-audi-r8-knurow-483026000.jpg'
                        },
                        {
                            name: 'limuzyna3',
                            stars: 1,
                            price: 400,
                            photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsWjwz4fIocm4fsuESQim3nPqP_fY2Ll1OFUlZmLXhCH8lCHsl'
                        }]
                },
                {
                    name: 'Gallery', active: false, content: [
